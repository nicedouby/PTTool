...
#define LOCTEXT_NAMESPACE "UPTToolInteractiveTool"
...
UPTToolInteractiveToolProperties::UPTToolInteractiveToolProperties()
{
...
void UPTToolInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UPTToolInteractiveTool::Setup()
{
	...
	Properties = NewObject<UPTToolInteractiveToolProperties>(this, "Measurement");
...
void UPTToolInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UPTToolInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UPTToolInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UPTToolInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UPTToolInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UPTToolInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UPTToolInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UPTToolInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UPTToolInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
