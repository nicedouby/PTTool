...
#include "PTToolInteractiveTool.generated.h"


/**
 * Builder for UPTToolInteractiveTool
 */
UCLASS()
class PTTOOL_API UPTToolInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UPTToolInteractiveTool
 */
UCLASS(Transient)
class PTTOOL_API UPTToolInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UPTToolInteractiveToolProperties();
...
/**
 * UPTToolInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class PTTOOL_API UPTToolInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UPTToolInteractiveToolProperties> Properties;
